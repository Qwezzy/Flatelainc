...
export default function TravelPillar() {
  return (
    <>
      <section
      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-4 flex flex-col gap-4">
            <Reveal>
              <p className="eyebrow text-moss">{TRAVEL.heroEyebrow}</p>
            </Reveal>
            <Reveal delay={0.05}>
              <span
      ...
      <section
        ...
        aria-labelledby="travel-purpose-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <Reveal>
              <h2
                id="travel-purpose-heading"
      ...
      <section
        ...
        aria-labelledby="travel-programmes-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <SectionHeader
            eyebrow="Intended programmes"
            headline={TRAVEL.programmesHeading}
            subhead={TRAVEL.programmesIntro}
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {TRAVEL.programmes.map((programme, i) => (
      ...
      <section
        ...
        aria-labelledby="travel-limits-heading"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 flex flex-col gap-5">
            <Reveal>
              <h2
                id="travel-limits-heading"
                className="font-serif-display font-semibold text-display-md text-brown"
              >
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <Reveal delay={0.14}>
              <div className="bg-brown text-cream rounded-lg p-8 flex flex-col gap-3">
                <p className="eyebrow text-moss">{TRAVEL.contact.heading}</p>
                <p className="font-sans text-body text-cream/80 leading-[1.65]">
                  {TRAVEL.contact.body}
                </p>
                <a
                  href={`mailto:${TRAVEL.contact.email}`}
