  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-4 flex flex-col gap-4">
            <Reveal>
              <p className="eyebrow text-moss">{EDUCATION.heroEyebrow}</p>
            </Reveal>
            <Reveal delay={0.05}>
              <span
      ...
      <section
        ...
        aria-labelledby="education-purpose-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <Reveal>
              <h2
                id="education-purpose-heading"
                className="font-serif-display font-semibold text-display-md text-brown"
              >
                {EDUCATION.purpose.heading}
              </h2>
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <SectionHeader
            ...
            headline={EDUCATION.programmesHeading}
            subhead={EDUCATION.programmesIntro}
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {EDUCATION.programmes.map((programme, i) => (
      ...
      <section
        ...
        aria-labelledby="education-limits-heading"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 flex flex-col gap-5">
            <Reveal>
              <h2
                id="education-limits-heading"
                className="font-serif-display font-semibold text-display-md text-brown"
              >
                {EDUCATION.limits.heading}
              </h2>
              <p className="font-sans text-body text-ink leading-[1.65] mt-4">
            ...
            <Reveal delay={0.1}>
              <div className="bg-cream-paper border border-rule rounded-lg p-8 flex flex-col gap-3">
                ...
                <h3 className="font-serif font-semibold text-[24px] text-brown">
                  {EDUCATION.yearOne.heading}
                </h3>
                <p className="font-sans text-body text-ink leading-[1.65]">
                  {EDUCATION.yearOne.body}
                </p>
              </div>
            </Reveal>
            <Reveal delay={0.14}>
              <div className="bg-brown text-cream rounded-lg p-8 flex flex-col gap-3">
                <p className="eyebrow text-moss">{EDUCATION.contact.heading}</p>
                <p className="font-sans text-body text-cream/80 leading-[1.65]">
                  {EDUCATION.contact.body}
                </p>
                <a
                  href={`mailto:${EDUCATION.contact.email}`}
