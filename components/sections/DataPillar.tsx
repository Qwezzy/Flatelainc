  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-4 flex flex-col gap-4">
            <Reveal>
              <p className="eyebrow text-moss">{DATA.heroEyebrow}</p>
            </Reveal>
            <Reveal delay={0.05}>
              <span
            ...
            <Reveal delay={0.1} className="text-green mt-2">
              <PillarIcon icon="circuit" />
            </Reveal>
          </div>
          <div className="lg:col-span-8 flex flex-col gap-6">
            <Reveal>
              <h1
                id="data-hero-heading"
      ...
      <section
        ...
        aria-labelledby="data-purpose-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <Reveal>
              <h2
                id="data-purpose-heading"
      ...
      <section
        ...
        aria-labelledby="data-programmes-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <SectionHeader
            eyebrow="Intended offerings"
            headline={DATA.programmesHeading}
            subhead={DATA.programmesIntro}
          />
      ...
      <section
        className="bg-cream-soft py-20 lg:py-28 px-6 lg:px-12"
        aria-labelledby="data-connections-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {DATA.connections.items.map((item, i) => (
      ...
      <section
        ...
        aria-labelledby="data-limits-heading"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 flex flex-col gap-5">
            <Reveal>
              <h2
                id="data-limits-heading"
                className="font-serif-display font-semibold text-display-md text-brown"
              >
                {DATA.limits.heading}
              </h2>
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <Reveal delay={0.14}>
              <div className="bg-brown text-cream rounded-lg p-8 flex flex-col gap-3">
                <p className="eyebrow text-moss">{DATA.contact.heading}</p>
