...
export default function EnergyPillar() {
  return (
    <>
      <section
        className="bg-cream pt-28 lg:pt-36 pb-20 lg:pb-28 px-6 lg:px-12"
        aria-labelledby="energy-hero-heading"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-4 flex flex-col gap-4">
            <Reveal>
              <p className="eyebrow text-moss">{ENERGY.heroEyebrow}</p>
            </Reveal>
            <Reveal delay={0.05}>
              <span
      ...
      <section
        ...
        aria-labelledby="energy-programmes-heading"
      >
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <SectionHeader
            eyebrow="Intended programmes"
            headline={ENERGY.programmesHeading}
            subhead={ENERGY.programmesIntro}
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {ENERGY.programmes.map((programme, i) => (
      ...
      <section
        ...
        aria-labelledby="energy-limits-heading"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 flex flex-col gap-5">
            <Reveal>
              <h2
                id="energy-limits-heading"
                className="font-serif-display font-semibold text-display-md text-brown"
              >
                {ENERGY.limits.heading}
              </h2>
              <p className="font-sans text-body text-ink leading-[1.65] mt-4">
                {ENERGY.limits.body}
              </p>
